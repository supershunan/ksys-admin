...
export const userTypeMap = { 'sadmin': { v: '超级管理员', c: 'blue' },
  'admin': { v: '普通管理员', c: 'blue' },
  'publicize': { v: '推广员', c: 'blue' },
  'expert': { v: '达人', c: 'blue' },
  'user': { v: '用户', c: 'blue' } }
...
export const moneyLogTypeMap = { 'consume': { v: '消费', c: 'red' },
  'recharge': { v: '充值', c: 'green' },
  'income': { v: '收益', c: 'green' },
  'dividend': { v: '分红', c: 'green' },
  'cash': { v: '提现', c: 'orange' },
  'refund': { v: '退回', c: 'blue' } }
...
export const orderStatusMap = { 1: { v: '待付款', c: 'primary' },
  2: { v: '已支付', c: 'warning' },
  3: { v: '申请退款', c: 'warning' },
  4: { v: '退款驳回', c: 'warning' },
  5: { v: '已退款', c: 'error' },
